...
if user
  json.cache! ["v1.1", user, defined?(detail)] do
    ...
    json.amount user.user_account? ? user.user_account.amount : 0.0
    json.alipay_account user.user_account? ? user.user_account.alipay_account : ""
    json.alipay_name user.user_account? ? user.user_account.alipay_name : ""
  end
end
