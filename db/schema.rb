...
ActiveRecord::Schema.define(version: 20170809090802) do
  ...
  create_table "cashout_applies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["status"], name: "index_cashout_applies_on_status"
    t.index ["user_id"], name: "index_cashout_applies_on_user_id"
  end
  ...
  create_table "user_account_records", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ownerable_id"], name: "index_user_account_records_on_ownerable_id"
    t.index ["ownerable_type"], name: "index_user_account_records_on_ownerable_type"
    t.index ["user_id"], name: "index_user_account_records_on_user_id"
  end
